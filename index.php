...
$botToken = "6984264558:AAEEyFYczwz9t6FVCbJWM2QKXnQ26mMSKf4";
...
$keyboard = json_encode([
    'inline_keyboard' => [
        [
            ['text' => "𝐎𝐖𝐍𝐄𝐑", 'url' => "https://t.me/Y_1_M_1"],
            ['text' => "𝐅𝐑𝐄𝐄 𝐏𝐑𝐄𝐌𝐈𝐔𝐌", 'url' => "https://t.me/bot_checkyousef"],
        ],
    ]
]);
...
//=============PRICE===============//
if ($cdata2 == "price") {
    $priceText = "<b>\n" . str_repeat(' ', 20) . "『 𝑷𝒓𝒊𝒄𝒆 💸』" . str_repeat(' ', 20) . "\n╔═════════════════╗\n •├3 𝑫𝒂𝒚𝒔 𝑷𝒍𝒂𝒏 ⇢ 2$\n •├7 𝑫𝒂𝒚𝒔 𝑷𝒍𝒂𝒏 ⇢ 4$\n •├15 𝑫𝒂𝒚𝒔 𝑷𝒍𝒂𝒏 ⇢ 7$\n •├30 𝑫𝒂𝒚𝒔 𝑷𝒍𝒂𝒏 ⇢ 12$\n╚═════════════════╝\n •├Dev ➳ <code>@Y_1_M_1</code>\n━━━━━━━━━━━━━━━━━━━</b>";

    $priceKeyboard = json_encode([
        'inline_keyboard' => [
            [['text' => '𝑯𝑶𝑴𝑬', 'callback_data' => 'back2'], ['text' => '𝑩𝑼𝒀', 'url' => 'https://t.me/Y_1_M_1']]
        ]
    ]);
...
$channel = json_encode([
    'inline_keyboard' => [
        [['text' => "𝗚𝗿𝗼𝘂𝗽 ", 'url' => "https://t.me/bot_checkyousef"], ['text' => "𝗖𝗵𝗮𝗻𝗻𝗲𝗹", 'url' => "https://t.me/bot_chk"]],
        [['text' => "𝗕𝗔𝗖𝗞 ", 'callback_data' => 'back2']]
    ]
]);
...
𝑬𝒙𝒑𝒍𝒐𝒓𝒆 𝒎𝒆 𝒎𝒐𝒓𝒆 𝒃𝒚 𝒄𝒍𝒊𝒄𝒌𝒊𝒏𝒈 𝒕𝒉𝒆 𝒃𝒖𝒕𝒕𝒐𝒏𝒔 𝒃𝒆𝒍𝒐𝒘</b>");
    ...
    // Change this to your video url
    $backVideoUrl = "https://t.me/bot_checkyousef/3"; 
